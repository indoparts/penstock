    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Form data penjualan</h6>
            </div>
                ...
                <form action="{{ route('penjualan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control @error('lembar') is-invalid @enderror" name="lembar"
                                required value="{{ old('lembar') }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputAddress2">Tanggal</label>
                            <input type="date" class="form-control @error('tggl_transaksi') is-invalid @enderror" name="tggl_transaksi"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="ket" id="" cols="30" rows="10"
                            class="form-control @error('ket') is-invalid @enderror" value="{{ old('ket') }}"></textarea>
                    </div>
